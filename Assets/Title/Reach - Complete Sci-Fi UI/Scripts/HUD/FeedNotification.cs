...
namespace Michsky.UI.Reach
{
    ...
    public class FeedNotification : MonoBehaviour
    {
        ...
        {
            yield return new WaitForSeconds(ReachUIInternalTools.GetAnimatorClipLength(itemAnimator, "FeedNotification_In"));
            itemAnimator.enabled = false;
        }

        IEnumerator DisableItem()
        {
            yield return new WaitForSeconds(ReachUIInternalTools.GetAnimatorClipLength(itemAnimator, "FeedNotification_Out"));
