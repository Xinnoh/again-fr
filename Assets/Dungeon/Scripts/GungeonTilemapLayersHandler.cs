...
namespace Edgar.Unity.Examples.Gungeon
{
    ...
    public class GungeonTilemapLayersHandler : TilemapLayersHandlerBaseGrid2D
    {
        ...
        public override void InitializeTilemaps(GameObject gameObject)
        {
            ...
            wallsTilemapObject.tag = "WallTiles";
            floorTilemapObject.tag = "FloorTiles";
            collideableTilemapObject.tag = "CollideableTiles";
            floorTilemapObject.layer = LayerMask.NameToLayer("Floor"); // Set the layer by name
            wallsTilemapObject.layer = LayerMask.NameToLayer("Wall"); // Set the layer by name
            collideableTilemapObject.layer = LayerMask.NameToLayer("Obstacle"); // Set the layer by name
