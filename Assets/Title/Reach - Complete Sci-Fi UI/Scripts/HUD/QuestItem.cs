...
namespace Michsky.UI.Reach
{
    ...
    public class QuestItem : MonoBehaviour
    {
        ...
        {
            yield return new WaitForSeconds(ReachUIInternalTools.GetAnimatorClipLength(questAnimator, "QuestItem_In"));
            questAnimator.enabled = false;
        }

        IEnumerator DisableItem()
        {
            yield return new WaitForSeconds(ReachUIInternalTools.GetAnimatorClipLength(questAnimator, "QuestItem_Out"));
